	...
	function()	{
		...
		$("#options > span").on("click", 
			function ()	{
				...
				switch (this.id)	{
					case "home":
						location.href = "http://localhost/amelia/sc/parallax/index.htm#sctn_main";
						break;
						
					case "sctn-1":
						location.href = "http://localhost/amelia/sc/parallax/index.htm#sctn_1";
						break;
						
					case "sctn-2":
						location.href = "http://localhost/amelia/sc/parallax/index.htm#sctn_2";
						break;
						
					case "sctn-3":
						location.href = "http://localhost/amelia/sc/parallax/index.htm#sctn_3";
						break;
						
					case "sctn-4":
						location.href = "http://localhost/amelia/sc/parallax/index.htm#sctn_4";
						break;
					
					case "sctn-5":
						location.href = "http://localhost/amelia/sc/parallax/index.htm#sctn_5";
						break;
						
					case "sctn-6":
						location.href = "http://localhost/amelia/sc/parallax/index.htm#sctn_6";
						break;
				}
			}
		);
